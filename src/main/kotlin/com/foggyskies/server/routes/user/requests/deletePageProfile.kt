...
import com.foggyskies.server.databases.mongo.codes.testpacage.content.collections.deleteCollection
import com.foggyskies.server.databases.mongo.codes.testpacage.content.collections.getAllAddressesContent
...
fun Route.deletePageProfile(isCheckToken: Boolean) = cRoute(
    ...
    val content = ContentDataBase.Content.getAllAddressesContent(idPageProfile)
    ...
    ContentDataBase.Content.deleteCollection(idPageProfile)
